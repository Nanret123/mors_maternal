      ...
      <form>
            ...
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  >
                    <button className="bg-red-500 p-2 rounded-full text-white text-[18px]   cursor-pointer mt-6">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
        ...
        <div className="mt-7">
          <button
            ...
            className="bg-primaryColor text-{18px} leading-{38px} w-full py-3 px-4 rounded-lg"
          >
            Update Profile
          </button>
        </div>
